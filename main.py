...
# 模板消息接口id
template1 = os.environ["TEMPLATE_ID1"] # 自定义模板一的模板消息接口id号
template2 = os.environ["TEMPLATE_ID2"] # 自定义模板二的模板消息接口id号，不启用不用填写
template3 = os.environ["TEMPLATE_ID3"] # 自定义模板三的模板消息接口id号，不启用不用填写
template4 = os.environ["TEMPLATE_ID4"] # 自定义模板四的模板消息接口id号，不启用不用填写
# 关注的成员ID，测试号页面的微信号，实则为账户的openID
user_id = os.environ["USER_ID"]
# 天行数据
key = os.environ["TIANXINGKEY"]
# 心知天气
zxkey = os.environ["ZXKEY"]
# 高德key
gdkey = os.environ["GDKEY"]

# 生日日期参数填写
birthday = os.environ['BIRTHDAY'] # 格式 %month-%day 【用月份-日期格式填写，不要出现年份】
# 相处开始日期
start_date = os.environ['START_DATE'] # 使用年份-月份-日期的形式填写

location = os.environ['LOCATION'] # 心知天气api 空气质量监测地区，英文拼写
cityacode = os.environ['CITYACODE'] # 高德地图天气情况获取，城市acode 参照readme文档填写
